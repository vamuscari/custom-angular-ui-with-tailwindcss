...
/** @docs-private */
export const _TsdInputBase = mixinErrorState(
  class {
    /**
...
@Directive({
  ...
  providers: [{ provide: MatFormFieldControl, useExisting: TsdInput }],
})
export class TsdInput
  extends _TsdInputBase
  implements
    ...
    CanUpdateErrorState
{
  protected _uid = `tsd-input-${nextUniqueId++}`;
  ...
  constructor(
    ...
    fieldLabel.classList.add('tsdLabel');
    fieldLabel.setAttribute('for', element.id);
    fieldLabel.innerHTML = element.getAttribute('label') || '';
    parentElement.insertBefore(fieldDiv, element);
...
//   selector: '[tsdInput]'
// })
// export class TsdInputDirective implements OnChanges{
//
...
//     this.inputElement.classList.add('tsdInput');
//     this.parentElement = this.document.createElement('div');
//     this.parentElement.classList.add('w-full', 'flex', 'flex-col', 'justify-center');
//     this.renderer.insertBefore( this.renderer.parentNode(this.el.nativeElement),  this.parentElement, this.el.nativeElement ) ;
//     this.parentElement.appendChild(this.el.nativeElement)
//   }
//   ngOnChanges() {
//     if(this.label){
//       let labelElement = this.document.createElement('label');
//       labelElement.classList.add('tsdLabel');
//       labelElement.innerHTML = this.label;
//       if(this.inputElement.hasAttribute('required')) labelElement.innerHTML += '<span class="ml-1 text-red-700">*</span>';
//       this.renderer.insertBefore( this.parentElement,  labelElement, this.el.nativeElement ) ;
//     }
//   }
// }

//<label id="listbox-label" class="block text-sm font-medium text-gray-700 ml-4">{{label}}
//<span *ngIf="required" class="ml-1 text-red-700">*</span></label>
